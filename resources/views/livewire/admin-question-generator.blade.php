<div class="glass-card-strong rounded-[28px] p-5">
    <div class="mb-4 rounded-2xl px-4 py-3 text-sm {{ $apiConfigured ? 'bg-emerald-50 text-emerald-700' : 'bg-amber-50 text-amber-700' }}">
        {{ $apiConfigured ? 'Gemini API is configured. New AI-generated questions can be synced now.' : 'Gemini API key missing. Add GEMINI_API_KEY in .env to generate live questions.' }}
    </div>
